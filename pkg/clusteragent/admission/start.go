...
func StartControllers(ctx ControllerContext, datadogConfig config.Component, wmeta workloadmeta.Component, sh clusterspot.PodHandler) ([]webhook.Webhook, error) {
